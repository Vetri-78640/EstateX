    ...
    <div className="bg-glass rounded-xl shadow-lg p-6 mb-6 dark:text-gray-100">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          placeholder="Enter city" value={filters.location}
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2">
          <input type="range" min={minPossible} max={maxPossible} step={10000} value={min}
              onChange={e => {
          ...
          <input type="range" min={minPossible} max={maxPossible} step={10000} value={max}
            onChange={e => {
